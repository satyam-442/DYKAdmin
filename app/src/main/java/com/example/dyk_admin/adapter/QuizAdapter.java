package com.example.dyk_admin.adapter;
...
import com.example.dyk_admin.SetsActivity;
...
public class QuizAdapter extends RecyclerView.Adapter<QuizAdapter.viewHolder> {
    ...
    private List<Quiz> categoryList;
    DeleteListener deleteListener;

    public QuizAdapter(List<Quiz> categoryList, DeleteListener deleteListener) {
